...
/************************** Buffer Page Decls *********************/
/* Absolute upper bound on buffer pool size (for safety) */
#define PF_MAX_BUFS_LIMIT 100

/* Actual buffer pool size (runtime configurable, defined in pf.c) */
extern int PF_MAX_BUFS;
